  ...
  return (
    ...
    >
      ...
      <BottomTab.Screen
        ...
        options={{
          title: 'おすすめ',
          tabBarIcon: ({ color }) => <AntDesign name="star" size={24} color="orange" />
        }}
      />
      <BottomTab.Screen
        name="Search"
      ...
      <BottomTab.Screen
        ...
        options={{
          title: 'のせる',
          tabBarIcon: ({ color }) => <MaterialIcons name="post-add" size={24} color="black" />
        }}
      />
      <BottomTab.Screen
        name="Purchase"
        ...
        options={{
          title: 'かいもの',
          tabBarIcon: ({ color }) => <FontAwesome5 name="carrot" size={24} color="black" />
        }}
      />
      <BottomTab.Screen
        name="Record"
        ...
        options={{
          title: 'きろく',
          tabBarIcon: ({ color }) => <MaterialCommunityIcons name="cards-outline" size={24} color="black" />
        }}
      />
    </BottomTab.Navigator>
  )
